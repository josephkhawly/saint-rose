...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_steps_accent_color" AS ENUM('rose', 'deep-rose', 'dark-chocolate', 'mint', 'lavender', 'sky', 'garden', 'olive', 'lima');
  CREATE TYPE "public"."enum__pages_v_blocks_steps_accent_color" AS ENUM('rose', 'deep-rose', 'dark-chocolate', 'mint', 'lavender', 'sky', 'garden', 'olive', 'lima');
  ...
  CREATE TABLE "pages_blocks_steps" (
  	...
  	"eyebrow" varchar,
  	"lede" varchar,
  	"accent_color" "enum_pages_blocks_steps_accent_color" DEFAULT 'rose',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_steps" (
  	...
  	"eyebrow" varchar,
  	"lede" varchar,
  	"accent_color" "enum__pages_v_blocks_steps_accent_color" DEFAULT 'rose',
  	"_uuid" varchar,
  	"block_name" varchar
  );
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_steps_accent_color";
  DROP TYPE "public"."enum__pages_v_blocks_steps_accent_color";`)
}
